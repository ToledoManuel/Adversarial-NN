...
def parse_args (cmdline_args=sys.argv[1:], backend=False, adversarial=True, plots=False):
    ...
    parser.add_argument('--input',  action='store', type=str,
                        default='C:/Users/knukl/OneDrive/TEC/ESTANCIA/Final/FINAL/input/', help='Input directory, from which to read HDF5 data file.')
    parser.add_argument('--output', action='store', type=str,
                        default='./output/', help='Output directory, to which to write results.')
    parser.add_argument('--config', action='store', type=str,
                        default='./configs/configs.json', help='Configuration file.')
    ...
    if adversarial:
        ...
        group_optimise.add_argument('--optimise-classifier',  dest='optimise_classifier',  action='store_true',
                            help='Optimise stand-alone classifier', default=True)
...
def configure_tensorflow (args, num_cores):
    ...
    config = tf.compat.v1.ConfigProto(intra_op_parallelism_threads=num_cores * 2,
...
DECORRELATION_VARIABLES = ['m']
INPUT_VARIABLES = ['Tau21J1', 'Tau21J2', 'Tau32J1', 'Tau32J2']
#INPUT_VARIABLES = ['Tau21J1', 'Tau21J2']
# INPUT_VARIABLES = ['Tau21', 'Tau32']
